...
- [x] `src/app/transport/datachannel.spec.mts` — API 互換性 large テスト追加 (3テストパス / 1テスト失敗: `createOffer` が5秒以内に resolve するため [調査中](../../task/daemon-cli/03-test-createoffer-failure.md))
